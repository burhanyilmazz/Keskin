      ...
      <Layout products={products} className='white-bg'>
        ...
        <div className='content'>
          <div className={classNames('container', styles['product-detail'])}>
            <div className={styles['text']}>
              ...
              {product.pdfFile && <LinkButton href={product.pdfFile} text="TDS Download" icon={'download'} className={styles['button']}/> }
            </div>
        ...
        {modalOpen && <Modal onClose={() => setModalOpen(false)}>
          <div className={styles['modal']}>
            <ContactForm type={'product'} title="Contact Form" pid={product.id} />
          </div>
        </Modal> }
      </Layout>
    </>
